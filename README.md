...
```bash
git clone https://github.com/22f3001607/tds-project2.git
cd tds-project2
```
...
**Author**: Smit Sabalpara
**Course**: Tools in Data Science (TDS)
**Institution**: IIT Madras

For questions or issues, please open an issue on the [GitHub repository](https://github.com/22f3001607/tds-project2).